...
_SYSTEM_PROMPT = (
    ...
    "vem de um trecho.\n\n"
    "Se os trechos tratarem do assunto mas não responderem exatamente ao caso "
    "perguntado, responda com o que eles estabelecem, citando a fonte — deixe "
    "claro o que o regimento diz e não complete o que ele não diz.\n\n"
